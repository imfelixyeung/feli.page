...
const PageHead = ({ title }: Props) => {
  ...
  return (
    <Head>
      ...
      <meta name="twitter:image" content="/assets/images/im.feli.page.png" />
      <meta property="og:title" content={displayTitle} />
      <meta property="og:image" content="/assets/images/im.feli.page.png" />

      <title>{displayTitle}</title>
      <link rel="icon" href="/favicon.png" />
      <link rel="manifest" href="/manifest.json" />
      <link rel="apple-touch-icon" href="/assets/images/im.feli.page.png" />
